...
export type { DeSciPlatform } from "./contracts/DeSciPlatform";
export { DeSciPlatform__factory } from "./factories/contracts/DeSciPlatform__factory";
export type { IIpNFT } from "./contracts/interfaces/IIpNFT";
export { IIpNFT__factory } from "./factories/contracts/interfaces/IIpNFT__factory";
export type { IpNFT } from "./contracts/IpNFT";
export { IpNFT__factory } from "./factories/contracts/IpNFT__factory";
